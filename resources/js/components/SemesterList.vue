            ...
            >
                <template v-slot:top>
                    <v-toolbar flat>
                        <v-toolbar-title class="text-center"
                            >Semester Lists</v-toolbar-title
                        >
                    </v-toolbar>
                </template>
                ...
                <template v-slot:item.action="{ item }">
                    <div style="display: flex; align-items: center; gap: 8px">
                        <v-btn small color="primary" @click="editSemester(item)"
                            >Edit</v-btn
                        >
                        <v-btn small color="error" @click="deleteSemester(item)"
                            >Delete</v-btn
                        >
                    </div>
                </template>
                ...
                <v-card>
                    ...
                    <v-card-actions>
                        <v-btn color="blue darken-1" text @click="closeDialog"
                            >Cancel</v-btn
                        >
                        <v-btn color="blue darken-1" text @click="saveSemester"
                            >Save</v-btn
                        >
                    </v-card-actions>
                </v-card>
...
export default {
    ...
    methods: {
        ...
        async saveSemester() {
            if (
                new Date(this.editItem.end_date) <
                new Date(this.editItem.start_date)
            ) {
                this.warningMessage =
